...
function Signup() {
  ...
  <div class="max-w-4xl flex flex-col lg:flex-row bg-white shadow-md rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800">
    <div class="w-full lg:w-1/2">
      <img class="object-cover w-full h-full" src="https://flowbite.com/application-ui/demo/images/authentication/create-account.jpg" alt="login image"/>
    </div>

    <div class="w-full lg:w-1/2 p-8 lg:p-16 flex flex-col justify-center">
      <h2 class="text-3xl font-bold text-gray-900 mb-6 dark:text-white">Create a Free Account</h2>
      <form action="#">
        ...
        <div class="mb-4">
          <label for="password" class="block text-sm font-medium text-gray-700 mb-2 dark:text-white">Confirm password</label>
          <input type="password" name="password" id="password" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="••••••••" required/>
        </div>
        ...
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center">
            ...
            <label for="remember" class="ml-2 block text-sm text-gray-900 dark:text-white">I accept the <a href='' class="text-sm text-blue-600 hover:underline">Terms and Conditions</a></label>
          </div>
        
        </div>
   
        <button type="submit" class="w-36 h-12 bg-blue-600 text-white font-semibold py-2 rounded-md hover:bg-blue-700 transition">Create account</button>

        <div class="mt-6 text-sm text-gray-500">
          Already have an account? 
          <Link to="/Signin" class="text-blue-600 hover:underline">Login Here</Link>
        </div>
      </form>
    </div>
  </div>
