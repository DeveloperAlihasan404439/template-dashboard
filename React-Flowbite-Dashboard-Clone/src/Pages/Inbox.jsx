...
function Inbox() {
  ...
  <>
    ...
    <div class="w-full mt-16 p-4 sm:ml-64 dark:bg-gray-900 ">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center py-5 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                <ul class="flex gap-4 items-center">
        <li class="border-l h-7"></li> 
        <li class="cursor-pointer text-2xl">
          <IoMdSettings class="text-gray-500" />
        </li>
        <li class="cursor-pointer text-2xl">
          <PiTrashFill class="text-gray-500" />
        </li>
        <li class="cursor-pointer text-2xl">
          <FaExclamationCircle class="text-gray-500" />
        </li>
        <li class="cursor-pointer text-2xl">
          <CiMenuKebab class="text-gray-500" />
        </li>
        <li class="border-l h-7"></li> 
      </ul>
        
                </th>
                <td class="text-lg py-3 text-black">
                <Link to="/Compose">
      <button
        className="flex items-center justify-center h-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-6 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
      >
        <svg
          className="mr-1 h-7 w-6"
          fill="currentColor"
          viewBox="0 0 20 20"
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://flowbite.com/application-ui/demo/images/users/roberta-casas.png" alt="Jese image"/>
                    <div class="ps-3">
                        <div class="text-base font-semibold">Neils Sams</div>   
                    </div>
                </th>
                <td className="py-4 text-lg pr-16 text-black">
                 Am no an listening depending up believing. Enough around remove to barton agreed regret in or it. Advantage mr estimable be...
                </td> 
            </tr>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="w-4 p-4">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://flowbite.com/application-ui/demo/images/users/roberta-casas.png" alt="Jese image"/>
                    <div class="ps-3">
                        <div class="text-base font-semibold">Roberta Casas</div>    
                    </div>
                </th>
                <td className="py-4 text-lg pr-22">
                 Am no an listening depending up believing. Enough around remove to barton agreed regret in or it. Advantage mr estimable be...
                </td>
            </tr>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://flowbite.com/application-ui/demo/images/users/michael-gough.png" alt="Jese image"/>
                    <div class="ps-3">
                        <div class="text-base font-semibold">Roberta Casas</div>  
                    </div>
                </th>
                <td className="py-4 text-lg pr-16">
                Am no an listening depending up believing. Enough around remove to barton agreed regret in or it. Advantage mr estimable be...
               </td>
            </tr>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://flowbite.com/application-ui/demo/images/users/jese-leos.png" alt="Jese image"/>
                    <div class="ps-3">
                        <div class="text-base font-semibold">Roberta Casas</div>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://flowbite.com/application-ui/demo/images/users/bonnie-green.png" alt="Jese image"/>
                    <div class="ps-3">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://flowbite.com/application-ui/demo/images/users/helene-engels.png" alt="Jese image"/>
                    <div class="ps-3">
            ...
            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="https://flowbite.com/application-ui/demo/images/users/thomas-lean.png" alt="Jese image"/>
                    <div class="ps-3">
...
<div class="flex flex-col items-start mt-10">
  <span class="text-md  text-gray-700 dark:text-gray-400">
      Showing <span class="font-semibold text-base text-gray-900 dark:text-white">1</span>-<span class="font-semibold text-base text-gray-900 dark:text-white ">20</span> of <span class="font-semibold text-base text-gray-900 dark:text-white">100</span>
  </span>
</div>
    </div>
