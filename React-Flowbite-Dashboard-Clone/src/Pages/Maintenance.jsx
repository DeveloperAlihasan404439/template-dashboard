...
function Maintenance() {
  ...
  return (
    ...
    <div class="block md:max-w-lg">
        <img src="https://flowbite.com/application-ui/demo/images/illustrations/maintenance.svg" alt="maintenance image"/>
    </div>
    <div class="text-center xl:max-w-4xl">
        ...
        <p class="mb-5 text-base font-normal text-gray-500 md:text-lg dark:text-gray-400">Sorry for the inconvenience but we’re performing some maintenance at the moment. If you need to you can always <a href="#" class="text-blue-700 hover:underline dark:text-blue-500">contact us</a>, otherwise we’ll be back online shortly!.</p>
